...
const Emailtemplate = (email, resetLink, subject, message) => {
                            ...
                            <tr>
                                <td align="center" style="padding:0;">
                                    ...
                                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                                        ...
                                        <tr>
                                            <td style="padding:30px;background-color:#ffffff;text-align: center;">
                                                <a href=${urls.login_url} style="text-decoration:none;">
                                                    <img src=${imageURL} width="165" alt="Logo" style="margin-bottom:10px;width:165px;max-width:80%;height:auto;border:none;text-decoration:none;color:#ffffff;"></a>
                                        ...
                                        <tr>
                                            <td style="padding:30px;text-align:center;font-size:12px;background-color:#5e84fc;color:#ffffff;">
                                                <p style="margin:0;font-size:14px;line-height:20px;">&reg;This email was sent by Load Tripping. &copy; 2023 All rights reserved.<br></p>
                                                <a href=${facebookLink} style="text-decoration:none;margin-bottom:1%;margin-top: 1%;">
                                    <img
                                    src=${FacebookImageUrl} width="24" alt="Logo"
